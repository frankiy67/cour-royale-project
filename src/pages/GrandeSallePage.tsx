...
const PHOTOS = [
  ...
  { src: "/salles/grande-salle-5.jpg", alt: "Grande Salle — espace convivial kitchenette" },
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <motion.div variants={fadeInUp} className="mb-12">
          <div className="flex flex-wrap items-start gap-4 mb-4">
            <span className="font-inter text-xs uppercase tracking-[0.2em] text-accent bg-accent/10 px-3 py-1 rounded-full">
              Bâtiment du Moulin · Grande Salle
            </span>
        ...
        {/* Plans */}
        <motion.div variants={fadeInUp} className="mb-12">
          <h2 className="font-playfair text-foreground text-2xl mb-6">{t('pages_salles.plans')}</h2>
            ...
            {PLANS.map((p) => (
              <div key={p.src} className="bg-card rounded-xl border border-border">
                ...
                <div className="p-4 bg-white rounded-b-xl">
                  <img
                    src={p.src}
                    alt={`${t(`pages_salles.${p.labelKey}`)} — Grande Salle`}
