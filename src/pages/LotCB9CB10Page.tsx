...
const PLANS = [
  { labelKey: "plan_masse", title: "Bâtiment C — Le Moulin (vert)", src: "/images/plans/plan-moulin-masse.webp" },
  { labelKey: "plan_sol",   title: "Lot CB9 & CB10 — RDC",         src: "/images/plans/plan-moulin-cb9.webp" },
];
...
export default function LotCB9CB10Page() {
  ...
  const equipements = t('equipements_cb9', { returnObjects: true }) as string[];
