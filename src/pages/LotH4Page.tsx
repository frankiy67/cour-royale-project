...
const PLAN_SOL   = `${CLD}HALLE_002_hudnb2`;

const PHOTOS = [
  { src: "/lots/17m2-1.jpg", alt: "Vue extérieure / façade bâtiment Halle" },
  { src: "/lots/17m2-2.jpg", alt: "Intérieur lumineux sol clair" },
  { src: "/lots/17m2-3.jpg", alt: "Intérieur avec lumière rasante / porte" },
];
      ...
      >
        ...
        <motion.div variants={fadeInUp} className="mb-12">
          ...
          <p className="font-inter text-muted-foreground text-lg leading-relaxed max-w-2xl">
            Lot H4 : Bureau de 12 m² au rez-de-chaussée + 5 m² de parties communes.
            Les parties communes comprennent des toilettes et un coin café. Simple et lumineux,
            le bureau bénéficie de larges fenêtres donnant sur la cour.
          </p>
        </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-card rounded-xl border border-border overflow-hidden">
              <div className="px-4 py-3 border-b border-border">
                ...
                <p className="font-inter text-sm text-foreground font-medium mt-0.5">Lot H4 — RDC (jaune)</p>
              </div>
              <img
                src={PLAN_SOL}
                alt="Plan de sol — Lot H4 RDC"
                className="w-full object-contain p-4 bg-white"
                loading="lazy"
              />
            </div>
