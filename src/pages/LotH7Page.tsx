...
const PLANS = [
  { labelKey: "plan_masse", title: "Bâtiment E — La Halle (orange)", src: "/images/plans/plan-halle-masse.webp" },
  { labelKey: "plan_sol",   title: "Lot H7 — RDC (orange)",          src: "/images/plans/plan-halle-h7.webp" },
];
...
export default function LotH7Page() {
  ...
  const equipements = t('equipements_h7', { returnObjects: true }) as string[];
