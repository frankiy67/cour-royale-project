...
const LOTS_CONFIG = [
  { key: "cb9", plan: "/images/plans/plan-moulin-cb9.webp",   link: "/lots/cb9-cb10" },
  { key: "h4",  plan: null,                                    link: "/lots/h4" },
  { key: "d14", plan: "/images/plans/plan-horloge-d14.webp",  link: "/lots/d14" },
  { key: "h7",  plan: "/images/plans/plan-halle-h7.webp",     link: "/lots/h7" },
];
...
export default function BureauxSection() {
  ...
  return (
    <section
      ...
      className="relative"
      style={{
        backgroundImage: "url('/images/bureaux-bg.webp')",
